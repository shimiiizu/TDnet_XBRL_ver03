...
class FileManager:
    ...
    def delete_files(folder: Path, pattern: str = "*.zip"):
        ...
        """
        from sc.fileio import files_deleter
    ...
    def delete_all_files(folder: Path):
        ...
        指定フォルダ内の全ファイル削除
        """
        from sc.fileio import all_files_deleter
    ...
    def create_folder(path: Path):
        ...
        フォルダ作成
        """
        from sc.fileio import xbrlfile_folder_creater
    ...
    def delete_folder(path: Path):
        ...
        フォルダ削除
        """
        from sc.fileio import folder_deleter
    ...
    def move_zipfiles(source: Path, destination: Path):
        ...
        """
        from sc.fileio import zipfile_mover
    ...
    def unzip_all(folder: Path):
        ...
        """
        from sc.fileio import unzipper
    ...
    def get_statement_files(
        ...
        from sc.fileio import bs_filelist_maker
        from sc.fileio import pl_filelist_maker
